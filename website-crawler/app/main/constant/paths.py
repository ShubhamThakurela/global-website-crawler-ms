...
if mode == "DEV":
    ...
    IN_PATH = r"F:\drive\website_crawler_drive\in"
    SCRAPPED_PATH = r"F:\drive\website_crawler_drive\out"
    HISTORY_PATH = r"F:\drive\website_crawler_drive\history"
    PROCESSED_PATH = r"F:\drive\website_crawler_drive\processed"
    LOG_PATH = r"F:\drive\website_crawler_drive\logs"
    SERVER_HOST = r"127.0.0.0:6007"
