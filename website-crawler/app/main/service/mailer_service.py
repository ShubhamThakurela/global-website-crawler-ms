...
class MailUtilities(object):
    ...
    def send_success_notification(emails, download_link, start_dt):
        ...
        <body style="font-family:arial;">
                    ...
                    <table style="text-align:left;width:100%;font-family:arial">
        				...
        				Regards,
                        <br><span style="color:#0073A5">website Scraping</span>
                        <br><span style="color:#0073A5">(Kv2 Sub-Platform)</span>
                </html>
        '''
        ...
        head_message = "Website Scraping Completed"

        status = "Completed"

        to = emails
        cc = ConstantService.cc_mail_id()
        subject = " Website Scraping Completed Notification - Success"
    ...
    def send_failed_notification(emails, error_log, start_dt):
        ...
        # head_message = "Xignite {type} process has been started."
        head_message = " Website Scraping has failed."

        status = "Failed"

        to = emails
        cc = ConstantService.cc_mail_id()
        subject = "  Website Scraping Notification - Failed"
